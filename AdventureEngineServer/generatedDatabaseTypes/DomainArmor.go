...
type DomainArmor struct {
	...
	Category__DomainArmorCategory *int `json:"Category__DomainArmorCategory" gorm:"column:Category__DomainArmorCategory" mapstructure:"Category__DomainArmorCategory"`
