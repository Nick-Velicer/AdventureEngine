...
type DomainCurrencyDenomination struct {
	...
	IsLowestDenomination bool `json:"IsLowestDenomination" gorm:"column:IsLowestDenomination" mapstructure:"IsLowestDenomination"`

	// MultipleOfLowestDenomination corresponds to the JSON schema field
	// "MultipleOfLowestDenomination".
	MultipleOfLowestDenomination float64 `json:"MultipleOfLowestDenomination" gorm:"column:MultipleOfLowestDenomination" mapstructure:"MultipleOfLowestDenomination"`
