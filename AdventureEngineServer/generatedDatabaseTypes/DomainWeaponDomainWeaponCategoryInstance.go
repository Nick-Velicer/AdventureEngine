...
type DomainWeaponDomainWeaponCategoryInstance struct {
	...
	Category__DomainWeaponCategory *int `json:"Category__DomainWeaponCategory" gorm:"column:Category__DomainWeaponCategory" mapstructure:"Category__DomainWeaponCategory"`
	...
	Weapon__DomainWeapon *int `json:"Weapon__DomainWeapon" gorm:"column:Weapon__DomainWeapon" mapstructure:"Weapon__DomainWeapon"`
}
