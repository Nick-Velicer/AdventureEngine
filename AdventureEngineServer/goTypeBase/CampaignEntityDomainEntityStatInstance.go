...
type CampaignEntityDomainEntityStatInstanceJson struct {
	...
	CampaignEntityCampaignEntity *float64 `json:"CampaignEntity__CampaignEntity,omitempty" yaml:"CampaignEntity__CampaignEntity,omitempty" mapstructure:"CampaignEntity__CampaignEntity,omitempty"`
