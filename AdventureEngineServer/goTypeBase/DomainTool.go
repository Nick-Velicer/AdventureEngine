...
type DomainToolJson struct {
	...
	// CategoryDomainToolCategory corresponds to the JSON schema field
	// "Category__DomainToolCategory".
	CategoryDomainToolCategory *float64 `json:"Category__DomainToolCategory,omitempty" yaml:"Category__DomainToolCategory,omitempty" mapstructure:"Category__DomainToolCategory,omitempty"`
