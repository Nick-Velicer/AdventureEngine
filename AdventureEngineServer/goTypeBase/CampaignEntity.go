...
type CampaignEntityJson struct {
	...
	// StatsCampaignEntityDomainEntityStatInstance corresponds to the JSON schema
	// field "Stats__CampaignEntityDomainEntityStatInstance".
	StatsCampaignEntityDomainEntityStatInstance []float64 `json:"Stats__CampaignEntityDomainEntityStatInstance,omitempty" yaml:"Stats__CampaignEntityDomainEntityStatInstance,omitempty" mapstructure:"Stats__CampaignEntityDomainEntityStatInstance,omitempty"`

	// SubClassesCampaignEntityDomainSubClassInstance corresponds to the JSON schema
	// field "SubClasses__CampaignEntityDomainSubClassInstance".
	SubClassesCampaignEntityDomainSubClassInstance []float64 `json:"SubClasses__CampaignEntityDomainSubClassInstance,omitempty" yaml:"SubClasses__CampaignEntityDomainSubClassInstance,omitempty" mapstructure:"SubClasses__CampaignEntityDomainSubClassInstance,omitempty"`
