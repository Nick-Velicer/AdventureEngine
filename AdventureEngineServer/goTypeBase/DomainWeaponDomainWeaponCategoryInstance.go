...
type DomainWeaponDomainWeaponCategoryInstanceJson struct {
	...
	// CategoryDomainWeaponCategory corresponds to the JSON schema field
	// "Category__DomainWeaponCategory".
	CategoryDomainWeaponCategory *float64 `json:"Category__DomainWeaponCategory,omitempty" yaml:"Category__DomainWeaponCategory,omitempty" mapstructure:"Category__DomainWeaponCategory,omitempty"`
	...
	// WeaponDomainWeapon corresponds to the JSON schema field "Weapon__DomainWeapon".
	WeaponDomainWeapon *float64 `json:"Weapon__DomainWeapon,omitempty" yaml:"Weapon__DomainWeapon,omitempty" mapstructure:"Weapon__DomainWeapon,omitempty"`
}
