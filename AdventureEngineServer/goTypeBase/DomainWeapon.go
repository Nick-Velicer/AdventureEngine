...
type DomainWeaponJson struct {
	...
	// CategoriesDomainWeaponDomainWeaponCategoryInstance corresponds to the JSON
	// schema field "Categories__DomainWeaponDomainWeaponCategoryInstance".
	CategoriesDomainWeaponDomainWeaponCategoryInstance []float64 `json:"Categories__DomainWeaponDomainWeaponCategoryInstance,omitempty" yaml:"Categories__DomainWeaponDomainWeaponCategoryInstance,omitempty" mapstructure:"Categories__DomainWeaponDomainWeaponCategoryInstance,omitempty"`
