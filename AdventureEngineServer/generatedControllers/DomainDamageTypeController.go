...
func GetDomainDamageTypes(context *contextProviders.GeneratedControllerContext[types.DomainDamageType, dtos.DomainDamageTypeDTO, contextProviders.GetArgs[types.DomainDamageType], contextProviders.GetReturn[types.DomainDamageType]]) {
   if context == nil {
   ...
   serviceBuffer, err := context.ServiceAction(&contextProviders.GetArgs[types.DomainDamageType]{ Filters: &parsedFilters })
   if err != nil {
   ...
   for _, dbTypeInstance := range serviceBuffer {
      ...
      if (pointerToDTO == nil) {
         context.RequestContext.IndentedJSON(http.StatusInternalServerError, errors.New("DTO conversion resulted in nil for object of type DomainDamageType"))
         return
      }
...
func GetDomainDamageTypeById(context *contextProviders.GeneratedControllerContext[types.DomainDamageType, dtos.DomainDamageTypeDTO, contextProviders.GetByIdArgs[types.DomainDamageType], contextProviders.GetByIdReturn[types.DomainDamageType]]) {
   if context == nil {
      panic("No controller context provided")
   }
   ...
   serviceBuffer, err := context.ServiceAction(&contextProviders.GetByIdArgs[types.DomainDamageType]{ Id: idNum })
   if err != nil {
      context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
      return
   }
...
func SaveDomainDamageType(context *contextProviders.GeneratedControllerContext[types.DomainDamageType, dtos.DomainDamageTypeDTO, contextProviders.SaveArgs[types.DomainDamageType], contextProviders.SaveReturn[types.DomainDamageType]]) {
   if context == nil {
      panic("No controller context provided")
   }
   ...
   var DTOBuffer *dtos.DomainDamageTypeDTO = &dtos.DomainDamageTypeDTO{}
   var batchDTOBuffer []*dtos.DomainDamageTypeDTO
   ...
   if err := context.RequestContext.ShouldBindBodyWith(DTOBuffer, binding.JSON); err == nil {
      ...
      serviceBuffer = []*types.DomainDamageType{context.DTOFlattener(DTOBuffer)}
      serviceReturn, err := context.ServiceAction(&contextProviders.SaveArgs[types.DomainDamageType]{ Items: serviceBuffer })
      if err != nil {
         context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
         return
      }
      ...
      serviceBuffer = utils.Map(batchDTOBuffer, func(dto *dtos.DomainDamageTypeDTO) *types.DomainDamageType { return context.DTOFlattener(dto) })
      serviceReturn, err := context.ServiceAction(&contextProviders.SaveArgs[types.DomainDamageType]{ Items: serviceBuffer })
      if err != nil {
         context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
         return
      ...
      returnBuffer, err := utils.ErrorCompatibleMap(serviceReturn, func(dbReturn *types.DomainDamageType) (*dtos.DomainDamageTypeDTO, error) { return context.DTOConverter(dbReturn) })
