...
func GetDomainSpeciess(context *contextProviders.GeneratedControllerContext[types.DomainSpecies, dtos.DomainSpeciesDTO, contextProviders.GetArgs[types.DomainSpecies], contextProviders.GetReturn[types.DomainSpecies]]) {
   if context == nil {
   ...
   serviceBuffer, err := context.ServiceAction(&contextProviders.GetArgs[types.DomainSpecies]{ Filters: &parsedFilters })
   if err != nil {
   ...
   for _, dbTypeInstance := range serviceBuffer {
      ...
      if (pointerToDTO == nil) {
         context.RequestContext.IndentedJSON(http.StatusInternalServerError, errors.New("DTO conversion resulted in nil for object of type DomainSpecies"))
         return
      }
...
func GetDomainSpeciesById(context *contextProviders.GeneratedControllerContext[types.DomainSpecies, dtos.DomainSpeciesDTO, contextProviders.GetByIdArgs[types.DomainSpecies], contextProviders.GetByIdReturn[types.DomainSpecies]]) {
   if context == nil {
      panic("No controller context provided")
   }
   ...
   serviceBuffer, err := context.ServiceAction(&contextProviders.GetByIdArgs[types.DomainSpecies]{ Id: idNum })
   if err != nil {
      context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
      return
   }
...
func SaveDomainSpecies(context *contextProviders.GeneratedControllerContext[types.DomainSpecies, dtos.DomainSpeciesDTO, contextProviders.SaveArgs[types.DomainSpecies], contextProviders.SaveReturn[types.DomainSpecies]]) {
   if context == nil {
      panic("No controller context provided")
   }
   ...
   if err := context.RequestContext.ShouldBindBodyWith(DTOBuffer, binding.JSON); err == nil {
      ...
      serviceBuffer = []*types.DomainSpecies{context.DTOFlattener(DTOBuffer)}
      serviceReturn, err := context.ServiceAction(&contextProviders.SaveArgs[types.DomainSpecies]{ Items: serviceBuffer })
      if err != nil {
         context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
         return
      }
      ...
      serviceBuffer = utils.Map(batchDTOBuffer, func(dto *dtos.DomainSpeciesDTO) *types.DomainSpecies { return context.DTOFlattener(dto) })
      serviceReturn, err := context.ServiceAction(&contextProviders.SaveArgs[types.DomainSpecies]{ Items: serviceBuffer })
      if err != nil {
         context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
         return
      ...
      returnBuffer, err := utils.ErrorCompatibleMap(serviceReturn, func(dbReturn *types.DomainSpecies) (*dtos.DomainSpeciesDTO, error) { return context.DTOConverter(dbReturn) })
