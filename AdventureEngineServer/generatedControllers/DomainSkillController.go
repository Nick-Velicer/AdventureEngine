...
func GetDomainSkills(context *contextProviders.GeneratedControllerContext[types.DomainSkill, dtos.DomainSkillDTO, contextProviders.GetArgs[types.DomainSkill], contextProviders.GetReturn[types.DomainSkill]]) {
   if context == nil {
   ...
   serviceBuffer, err := context.ServiceAction(&contextProviders.GetArgs[types.DomainSkill]{ Filters: &parsedFilters })
   if err != nil {
      context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
      return
   }
   
   var returnBuffer []dtos.DomainSkillDTO
   for _, dbTypeInstance := range serviceBuffer {
      ...
      if (pointerToDTO == nil) {
         context.RequestContext.IndentedJSON(http.StatusInternalServerError, errors.New("DTO conversion resulted in nil for object of type DomainSkill"))
         return
      }
...
func GetDomainSkillById(context *contextProviders.GeneratedControllerContext[types.DomainSkill, dtos.DomainSkillDTO, contextProviders.GetByIdArgs[types.DomainSkill], contextProviders.GetByIdReturn[types.DomainSkill]]) {
   if context == nil {
      panic("No controller context provided")
   }
   ...
   serviceBuffer, err := context.ServiceAction(&contextProviders.GetByIdArgs[types.DomainSkill]{ Id: idNum })
   if err != nil {
      context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
      return
   }
...
func SaveDomainSkill(context *contextProviders.GeneratedControllerContext[types.DomainSkill, dtos.DomainSkillDTO, contextProviders.SaveArgs[types.DomainSkill], contextProviders.SaveReturn[types.DomainSkill]]) {
   if context == nil {
      panic("No controller context provided")
   }
   ...
   var DTOBuffer *dtos.DomainSkillDTO = &dtos.DomainSkillDTO{}
   var batchDTOBuffer []*dtos.DomainSkillDTO
   var serviceBuffer []*types.DomainSkill
   ...
   if err := context.RequestContext.ShouldBindBodyWith(DTOBuffer, binding.JSON); err == nil {
      ...
      serviceBuffer = []*types.DomainSkill{context.DTOFlattener(DTOBuffer)}
      serviceReturn, err := context.ServiceAction(&contextProviders.SaveArgs[types.DomainSkill]{ Items: serviceBuffer })
      if err != nil {
         context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
         return
      }
      ...
      serviceBuffer = utils.Map(batchDTOBuffer, func(dto *dtos.DomainSkillDTO) *types.DomainSkill { return context.DTOFlattener(dto) })
      serviceReturn, err := context.ServiceAction(&contextProviders.SaveArgs[types.DomainSkill]{ Items: serviceBuffer })
      if err != nil {
         context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
         return
      ...
      returnBuffer, err := utils.ErrorCompatibleMap(serviceReturn, func(dbReturn *types.DomainSkill) (*dtos.DomainSkillDTO, error) { return context.DTOConverter(dbReturn) })
