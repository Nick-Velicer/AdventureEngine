...
func GetDomainSubClasss(context *contextProviders.GeneratedControllerContext[types.DomainSubClass, dtos.DomainSubClassDTO, contextProviders.GetArgs[types.DomainSubClass], contextProviders.GetReturn[types.DomainSubClass]]) {
   if context == nil {
   ...
   serviceBuffer, err := context.ServiceAction(&contextProviders.GetArgs[types.DomainSubClass]{ Filters: &parsedFilters })
   if err != nil {
   ...
   for _, dbTypeInstance := range serviceBuffer {
      ...
      if (pointerToDTO == nil) {
         context.RequestContext.IndentedJSON(http.StatusInternalServerError, errors.New("DTO conversion resulted in nil for object of type DomainSubClass"))
         return
      }
...
func GetDomainSubClassById(context *contextProviders.GeneratedControllerContext[types.DomainSubClass, dtos.DomainSubClassDTO, contextProviders.GetByIdArgs[types.DomainSubClass], contextProviders.GetByIdReturn[types.DomainSubClass]]) {
   if context == nil {
      panic("No controller context provided")
   }
   ...
   serviceBuffer, err := context.ServiceAction(&contextProviders.GetByIdArgs[types.DomainSubClass]{ Id: idNum })
   if err != nil {
      context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
      return
   }
...
func SaveDomainSubClass(context *contextProviders.GeneratedControllerContext[types.DomainSubClass, dtos.DomainSubClassDTO, contextProviders.SaveArgs[types.DomainSubClass], contextProviders.SaveReturn[types.DomainSubClass]]) {
   if context == nil {
      panic("No controller context provided")
   }
   ...
   if err := context.RequestContext.ShouldBindBodyWith(DTOBuffer, binding.JSON); err == nil {
      ...
      serviceBuffer = []*types.DomainSubClass{context.DTOFlattener(DTOBuffer)}
      serviceReturn, err := context.ServiceAction(&contextProviders.SaveArgs[types.DomainSubClass]{ Items: serviceBuffer })
      if err != nil {
         context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
         return
      }
      ...
      serviceBuffer = utils.Map(batchDTOBuffer, func(dto *dtos.DomainSubClassDTO) *types.DomainSubClass { return context.DTOFlattener(dto) })
      serviceReturn, err := context.ServiceAction(&contextProviders.SaveArgs[types.DomainSubClass]{ Items: serviceBuffer })
      if err != nil {
         context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
         return
      ...
      returnBuffer, err := utils.ErrorCompatibleMap(serviceReturn, func(dbReturn *types.DomainSubClass) (*dtos.DomainSubClassDTO, error) { return context.DTOConverter(dbReturn) })
