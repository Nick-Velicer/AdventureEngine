...
func GetQuantifiers(context *contextProviders.GeneratedControllerContext[types.Quantifier, dtos.QuantifierDTO, contextProviders.GetArgs[types.Quantifier], contextProviders.GetReturn[types.Quantifier]]) {
   if context == nil {
   ...
   serviceBuffer, err := context.ServiceAction(&contextProviders.GetArgs[types.Quantifier]{ Filters: &parsedFilters })
   if err != nil {
   ...
   for _, dbTypeInstance := range serviceBuffer {
      ...
      if (pointerToDTO == nil) {
         context.RequestContext.IndentedJSON(http.StatusInternalServerError, errors.New("DTO conversion resulted in nil for object of type Quantifier"))
         return
      }
...
func GetQuantifierById(context *contextProviders.GeneratedControllerContext[types.Quantifier, dtos.QuantifierDTO, contextProviders.GetByIdArgs[types.Quantifier], contextProviders.GetByIdReturn[types.Quantifier]]) {
   if context == nil {
      panic("No controller context provided")
   }
   ...
   serviceBuffer, err := context.ServiceAction(&contextProviders.GetByIdArgs[types.Quantifier]{ Id: idNum })
   if err != nil {
      context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
      return
   }
...
func SaveQuantifier(context *contextProviders.GeneratedControllerContext[types.Quantifier, dtos.QuantifierDTO, contextProviders.SaveArgs[types.Quantifier], contextProviders.SaveReturn[types.Quantifier]]) {
   if context == nil {
      panic("No controller context provided")
   }
   ...
   var DTOBuffer *dtos.QuantifierDTO = &dtos.QuantifierDTO{}
   var batchDTOBuffer []*dtos.QuantifierDTO
   ...
   if err := context.RequestContext.ShouldBindBodyWith(DTOBuffer, binding.JSON); err == nil {
      ...
      serviceBuffer = []*types.Quantifier{context.DTOFlattener(DTOBuffer)}
      serviceReturn, err := context.ServiceAction(&contextProviders.SaveArgs[types.Quantifier]{ Items: serviceBuffer })
      if err != nil {
         context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
         return
      }
      ...
      serviceBuffer = utils.Map(batchDTOBuffer, func(dto *dtos.QuantifierDTO) *types.Quantifier { return context.DTOFlattener(dto) })
      serviceReturn, err := context.ServiceAction(&contextProviders.SaveArgs[types.Quantifier]{ Items: serviceBuffer })
      if err != nil {
         context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
         return
      ...
      returnBuffer, err := utils.ErrorCompatibleMap(serviceReturn, func(dbReturn *types.Quantifier) (*dtos.QuantifierDTO, error) { return context.DTOConverter(dbReturn) })
