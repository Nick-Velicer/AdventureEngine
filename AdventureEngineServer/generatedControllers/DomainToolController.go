...
func GetDomainTools(context *contextProviders.GeneratedControllerContext[types.DomainTool, dtos.DomainToolDTO, contextProviders.GetArgs[types.DomainTool], contextProviders.GetReturn[types.DomainTool]]) {
   if context == nil {
   ...
   serviceBuffer, err := context.ServiceAction(&contextProviders.GetArgs[types.DomainTool]{ Filters: &parsedFilters })
   if err != nil {
      context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
      return
   }
   
   var returnBuffer []dtos.DomainToolDTO
   for _, dbTypeInstance := range serviceBuffer {
      ...
      if (pointerToDTO == nil) {
         context.RequestContext.IndentedJSON(http.StatusInternalServerError, errors.New("DTO conversion resulted in nil for object of type DomainTool"))
         return
      }
...
func GetDomainToolById(context *contextProviders.GeneratedControllerContext[types.DomainTool, dtos.DomainToolDTO, contextProviders.GetByIdArgs[types.DomainTool], contextProviders.GetByIdReturn[types.DomainTool]]) {
   if context == nil {
      panic("No controller context provided")
   }
   ...
   serviceBuffer, err := context.ServiceAction(&contextProviders.GetByIdArgs[types.DomainTool]{ Id: idNum })
   if err != nil {
      context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
      return
   }
...
func SaveDomainTool(context *contextProviders.GeneratedControllerContext[types.DomainTool, dtos.DomainToolDTO, contextProviders.SaveArgs[types.DomainTool], contextProviders.SaveReturn[types.DomainTool]]) {
   if context == nil {
      panic("No controller context provided")
   }
   ...
   var DTOBuffer *dtos.DomainToolDTO = &dtos.DomainToolDTO{}
   var batchDTOBuffer []*dtos.DomainToolDTO
   var serviceBuffer []*types.DomainTool
   ...
   if err := context.RequestContext.ShouldBindBodyWith(DTOBuffer, binding.JSON); err == nil {
      ...
      serviceBuffer = []*types.DomainTool{context.DTOFlattener(DTOBuffer)}
      serviceReturn, err := context.ServiceAction(&contextProviders.SaveArgs[types.DomainTool]{ Items: serviceBuffer })
      if err != nil {
         context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
         return
      }
      ...
      serviceBuffer = utils.Map(batchDTOBuffer, func(dto *dtos.DomainToolDTO) *types.DomainTool { return context.DTOFlattener(dto) })
      serviceReturn, err := context.ServiceAction(&contextProviders.SaveArgs[types.DomainTool]{ Items: serviceBuffer })
      if err != nil {
         context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
         return
      ...
      returnBuffer, err := utils.ErrorCompatibleMap(serviceReturn, func(dbReturn *types.DomainTool) (*dtos.DomainToolDTO, error) { return context.DTOConverter(dbReturn) })
