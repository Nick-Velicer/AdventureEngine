...
func GetDomainStaticEffects(context *contextProviders.GeneratedControllerContext[types.DomainStaticEffect, dtos.DomainStaticEffectDTO, contextProviders.GetArgs[types.DomainStaticEffect], contextProviders.GetReturn[types.DomainStaticEffect]]) {
   if context == nil {
   ...
   serviceBuffer, err := context.ServiceAction(&contextProviders.GetArgs[types.DomainStaticEffect]{ Filters: &parsedFilters })
   if err != nil {
   ...
   for _, dbTypeInstance := range serviceBuffer {
      ...
      if (pointerToDTO == nil) {
         context.RequestContext.IndentedJSON(http.StatusInternalServerError, errors.New("DTO conversion resulted in nil for object of type DomainStaticEffect"))
         return
      }
...
func GetDomainStaticEffectById(context *contextProviders.GeneratedControllerContext[types.DomainStaticEffect, dtos.DomainStaticEffectDTO, contextProviders.GetByIdArgs[types.DomainStaticEffect], contextProviders.GetByIdReturn[types.DomainStaticEffect]]) {
   if context == nil {
      panic("No controller context provided")
   }
   ...
   serviceBuffer, err := context.ServiceAction(&contextProviders.GetByIdArgs[types.DomainStaticEffect]{ Id: idNum })
   if err != nil {
      context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
      return
   }
...
func SaveDomainStaticEffect(context *contextProviders.GeneratedControllerContext[types.DomainStaticEffect, dtos.DomainStaticEffectDTO, contextProviders.SaveArgs[types.DomainStaticEffect], contextProviders.SaveReturn[types.DomainStaticEffect]]) {
   if context == nil {
      panic("No controller context provided")
   }
   ...
   if err := context.RequestContext.ShouldBindBodyWith(DTOBuffer, binding.JSON); err == nil {
      ...
      serviceBuffer = []*types.DomainStaticEffect{context.DTOFlattener(DTOBuffer)}
      serviceReturn, err := context.ServiceAction(&contextProviders.SaveArgs[types.DomainStaticEffect]{ Items: serviceBuffer })
      if err != nil {
         context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
         return
      }
      ...
      serviceBuffer = utils.Map(batchDTOBuffer, func(dto *dtos.DomainStaticEffectDTO) *types.DomainStaticEffect { return context.DTOFlattener(dto) })
      serviceReturn, err := context.ServiceAction(&contextProviders.SaveArgs[types.DomainStaticEffect]{ Items: serviceBuffer })
      if err != nil {
         context.RequestContext.IndentedJSON(http.StatusInternalServerError, err.Error())
         return
      ...
      returnBuffer, err := utils.ErrorCompatibleMap(serviceReturn, func(dbReturn *types.DomainStaticEffect) (*dtos.DomainStaticEffectDTO, error) { return context.DTOConverter(dbReturn) })
